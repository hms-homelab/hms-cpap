...
echo "  CPAP_SOURCE=local      ./hms_cpap   # Read a ResMed card from a folder"
echo "  CPAP_SOURCE=lowenstein ./hms_cpap   # Read a Lowenstein Prisma card from a folder"
echo "  CPAP_SOURCE=sefam      ./hms_cpap   # Read a Sefam S.Box card from a folder"
echo "  CPAP_SOURCE=fysetc     ./hms_cpap   # Receive from FYSETC via MQTT"
echo ""
echo "The three folder modes all read CPAP_LOCAL_DIR; they differ in the card format."
echo ""
